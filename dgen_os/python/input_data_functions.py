...
def get_scenario_settings(schema, con):
    """
    Creates dataframe of default scenario settings from input_main_scenario_options tabl
...
def import_agent_file(scenario_settings, prng, con, cur, engine, model_settings, agent_file_status, input_name):
    ...
    **solar_agents** : 'Class'
    ...
    if agent_file_status == 'Use pre-generated Agents':
        ...
        print('Generating agents is not supported at this time. Please select "Use pre-generated Agents" in the input sheet')
        #solar_agents = Agents(agent_mutation.init_solar_agents(model_settings, scenario_settings, prng, cur, con, engine))
