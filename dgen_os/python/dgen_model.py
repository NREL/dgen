...
#                    solar_agents.chunk_on_row(financial_functions.calc_system_size_and_performance, cores=None, rate_switch_table=rate_switch_table)
                    ...
                    if model_settings.output_reeds_data==True:
                        if is_first_year==True:
