...
CREATE TABLE diffusion_template.input_ghp_finances_res 
(
...
DROP VIEW IF EXISTS diffusion_template.input_ghp_finances CASCADE;
CREATE VIEW diffusion_template.input_ghp_finances AS
...
FROM diffusion_template.input_ghp_finances_res
