...
SELECT parsel_2('dav-gis','mmooney','mmooney', 'diffusion_blocks.tract_geoms_ca_subregion', 'tract_id_alias', 
	...
	'diffusion_data_shared.ca_subregion_tracts_to_util_reg', 'aa', 50);
...
-- Remove tracts that do not intersect (they will not be used)
	...
	-- 64 nulls -- this makes sense because most of CA is covered by utilities with a sub territory, but not all
