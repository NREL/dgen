...
DROP TABLE IF EXISTS diffusion_template.input_wind_finances_res cascade;
CREATE TABLE diffusion_template.input_wind_finances_res 
(
...
DROP TABLE IF EXISTS diffusion_template.input_wind_finances_com cascade;
CREATE TABLE diffusion_template.input_wind_finances_com 
(
	year integer NOT null,
	-- loan params
	loan_term_yrs integer NOT NULL,
...
DROP TABLE IF EXISTS diffusion_template.input_wind_finances_ind cascade;
CREATE TABLE diffusion_template.input_wind_finances_ind 
(
	year integer NOT null,
	-- loan params
	loan_term_yrs integer NOT NULL,
...
DROP TABLE IF EXIStS diffusion_template.input_wind_finances_depreciation_schedule CASCADE;
