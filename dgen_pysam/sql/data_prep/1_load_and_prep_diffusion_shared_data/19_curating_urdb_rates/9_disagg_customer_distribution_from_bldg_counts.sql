...
------------------------------------------------
-- 1. Get the distribution of Agents Per County
------------------------------------------------
...
-- For CA:
-- **************
	-- we need to build the total counts per utility from the tract up
				...
				with no_ca_utility_tracts as 
	 				...
	 				with cnty as 
						...
						select distinct
							...
							a.county_fips,
							b.sector
						from urdb_rates.utility_county_geoms_20161005 a
